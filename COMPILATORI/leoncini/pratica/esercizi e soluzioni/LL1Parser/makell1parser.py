...
global tokens, variables, EPS, HPP, TOKENS 
tokens = {}
variables = {}
EPS = 0
HPP = 'll1parser.hpp'     # Default file name
TOKENS_H = 'tokens.h'   # Default file name
...
if __name__=='__main__':
    nargs = len(sys.argv)
    if nargs==1:
        print("Errore: manca l'indicazione della grammatica")
        sys.exit()
    else:
        HPP = sys.argv[1]+".hpp"
        TOKENS_H = "tokens_"+sys.argv[1]+".h"
        makehpp(sys.argv[1]+".pickle")
