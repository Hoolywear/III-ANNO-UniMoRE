...
#ifndef YY_YY_ASTPARSER_0_HPP_INCLUDED
# define YY_YY_ASTPARSER_0_HPP_INCLUDED
// "%code requires" blocks.
#line 12 "astparser-0.yy"

//# include <string>
//#include <exception>

#line 54 "astparser-0.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_UMINUS = 289,              // UMINUS
    TOK_NEGATE = 290               // NEGATE
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_startsymb = 37,                        // startsymb
        S_lfmprog = 38,                          // lfmprog
        S_deflist = 39,                          // deflist
        S_def = 40,                              // def
        S_extdef = 41,                           // extdef
        S_funcdef = 42,                          // funcdef
        S_prototype = 43,                        // prototype
        S_params = 44,                           // params
        S_main = 45,                             // main
        S_expr = 46,                             // expr
        S_arglist = 47,                          // arglist
        S_args = 48,                             // args
        S_condexpr = 49,                         // condexpr
        S_pairs = 50,                            // pairs
        S_pair = 51,                             // pair
        S_boolexpr = 52,                         // boolexpr
        S_literal = 53,                          // literal
        S_relexpr = 54,                          // relexpr
        S_letexpr = 55,                          // letexpr
        S_bindings = 56,                         // bindings
        S_binding = 57                           // binding
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_ALT ()
      {
        return symbol_type (token::TOK_ALT);
      }
#else
      static
      symbol_type
      ...
      make_BIND ()
      {
        return symbol_type (token::TOK_BIND);
      }
#else
      static
      symbol_type
      ...
      make_NEGATE ()
      {
        return symbol_type (token::TOK_NEGATE);
      }
#else
      static
      symbol_type
...
#line 1911 "astparser-0.hpp"




#endif // !YY_YY_ASTPARSER_0_HPP_INCLUDED
