...
dobbiamo dunque chiederci, per ottimizzare questi accessi, 
\begin{itemize}
...
\subsection{esempi di trasformazioni di loop}
...
matrix multiplication: esempio di come applicare il tiling
\begin{example}
...
dunque stiamo operando in maniera non lazy
